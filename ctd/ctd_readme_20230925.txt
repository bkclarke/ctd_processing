...
If PAR sensor was included in the sensor setup, sensor was removed for casts over 2000m. The xmlcon file would still include the sensor though.
...
\proc - Processed ASCII and binary CTD data. Data files and images of the CTD data after processing and derivations have been applied. A key to the headings of columns is included in \docs.
